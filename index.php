			...
			<nav class="navbar navbar-default navbar-fixed-top">
				...
				<div id="nav_top" class="collapse navbar-collapse">
					<ul class="nav navbar-nav navbar-right">
						<li><a id="nav_link_top" class="navbar-link nav_location" href="#p_top">トップ</a></li>
					...
					<div id="activity_box" class="post_box">
						...
						<div id="activity_post_news">
							<?php if(have_posts()): while(have_posts()): the_post(); ?>
								<?php if ( in_category(array('活動')) && in_category(array('NEWS')) ): ?> <!-- ループ開始 -->
								<a href="<?php the_permalink(); ?>">
									<div class="post row">
										<div class="post_date col-xs-2">
											<p class="post_year"><?php echo get_the_date('Y'); ?></p>
						...
						<div id="activity_post_event">
							<?php if(have_posts()): while(have_posts()): the_post(); ?>
								<?php if ( in_category(array('活動')) && in_category(array('EVENT')) ): ?> <!-- ループ開始 -->
								<a href="<?php the_permalink(); ?>">
									<div class="post row">
										<div class="post_date col-xs-2">
											<p class="post_year"><?php echo get_the_date('Y'); ?></p>
				...
				<div class="inner">
					...
					<div id="finding_box" class="post_box">
						<div id="finding_post_prize">
							<?php if(have_posts()): while(have_posts()): the_post(); ?>
								<?php if ( in_category(array('受賞'))): ?> <!-- ループ開始 -->
								<div class="post row">
									<div class="post_date col-xs-2">
										<p class="post_year"><?php echo get_the_date('Y'); ?></p>
										<p class="post_md"><?php echo get_the_date('m.d'); ?></p>
									...
									<div class="post_content col-xs-10">
										<div class="finding_post_text"><p><?php echo get_post_meta($post->ID,'name',true); ?></p></div>
										<p class="post_title"><?php the_title(); ?></p>
										<div class="post_text"><p><?php echo get_post_meta($post->ID,'prize',true); ?></p></div>
									</div>
								</div>
								<?php endif; ?>
							<?php endwhile; endif; ?> <!-- ループ終了 -->
						...
						<div id="finding_post_paper">
							<?php if(have_posts()): while(have_posts()): the_post(); ?> <!-- ループ開始 -->
								...
								<p class="finding_year"><?php echo get_the_date('Y'); ?></p>
								<?php endif; $year = get_the_date('Y'); ?>
								<div class="post row">
						...
						<div id="finding_post_lecture">
							<?php if(have_posts()): while(have_posts()): the_post(); ?> <!-- ループ開始 -->
								...
								<div class="post row">
									...
									<div class="post_content col-xs-10">
										<div class="finding_post_text"><?php the_content(); ?></div>
										<p class="post_title"><?php the_title(); ?></p>
										<div class="post_text"><p><?php echo get_post_meta($post->ID,'name',true); ?></p></div>
									</div>
								</div>
								<?php endif; ?>
							<?php endwhile; endif; ?> <!-- ループ終了 -->
